...
### [Spice up your music](https://gabristucchi.github.io/) 
...
* KEYS: It's possible to choose between different types of keys, including pianos, organs and pads. The set of possible sampled sounds is imported from [WebAudioFont](https://surikov.github.io/webaudiofont/).
...
Each instrument of the band has two levels of Spiciness: the higher it is the more complex and spicy will be its performance style!
...
Inspired by the colorful design of the _Moog Grandmother_ and built using the [Tone.js](https://tonejs.github.io/) framework, the monophonic Spicer Synthesizer gives the opportunity to jam on top of your spiced arrangement.
